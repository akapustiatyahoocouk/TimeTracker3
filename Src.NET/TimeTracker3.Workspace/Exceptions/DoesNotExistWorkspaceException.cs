...
namespace TimeTracker3.Workspace.Exceptions
{
    ...
    /// </summary>
    public class DoesNotExistWorkspaceException : WorkspaceException
    {
        //////////
        //  Construction
        ...
        /// </param>
        public DoesNotExistWorkspaceException(string objectTypeName, string propertyName, object propertyValue)
