...
namespace TimeTracker3.Workspace.Exceptions
{
    public class IncompatibleObjectsWorkspaceException : WorkspaceException
    {
        ...
        /// </param>
        public IncompatibleObjectsWorkspaceException(object obj1, object obj2)
        ...
        public IncompatibleObjectsWorkspaceException(object obj1, object obj2, Exception cause)
