...
namespace TimeTracker3.Workspace.Exceptions
{
    ...
    /// </summary>
    public class AlreadyExistsWorkspaceException : WorkspaceException
    {
        //////////
        //  Construction
        ...
        /// </param>
        public AlreadyExistsWorkspaceException(string objectTypeName, string propertyName, object propertyValue)
