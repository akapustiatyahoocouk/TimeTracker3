...
namespace TimeTracker3.Db.API.Exceptions
{
    ...
    /// </summary>
    public class InvalidPropertyValueDatabaseException : DatabaseException
    {
        //////////
        //  Construction
        ...
        /// </param>
        public InvalidPropertyValueDatabaseException(string objectTypeName, string propertyName, object propertyValue)
