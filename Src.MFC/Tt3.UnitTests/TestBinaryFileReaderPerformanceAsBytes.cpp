//
//  Tt3.UnitTests/TestBinaryFileReaderPerformanceAsBytes.cpp
//  
//  A test for the CBinaryFileReader performance (as bytes)
//
//////////
...
END_TT3_NAMESPACE
//  End of Tt3.UnitTests/TestBinaryFileReaderPerformanceAsBytes.cpp
