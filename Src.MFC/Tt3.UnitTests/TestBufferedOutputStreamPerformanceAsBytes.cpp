//
//  Tt3.UnitTests/TestBufferedOutputStreamPerformanceAsBytes.cpp
//  
//  A test for the CBufferedOutputStream output performance (as bytes)
//
//////////
...
void TestBufferedOutputStreamPerformanceAsBytes() throws(CTestException*)
{
    ...
    for (size_t iteration = 0; iteration < Iterations; iteration++)
    {
        ...
        {
            bos.Write(randomChunk[i % RandomChunkSize]);
        }
        bos.Close();
        fos.Close();
        remove(tempFileName);
...
END_TT3_NAMESPACE
//  End of Tt3.UnitTests/TestBufferedOutputStreamPerformanceAsBytes.cpp
