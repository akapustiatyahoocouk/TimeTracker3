//
//  Tt3.UnitTests/TestFileOutputStreamPerformanceAsChunks.cpp
//  
//  A test for the CFileOutputStream output performance (as chunks)
//
//////////
...
END_TT3_NAMESPACE
//  End of Tt3.UnitTests/TestFileOutputStreamPerformanceAsChunks.cpp
