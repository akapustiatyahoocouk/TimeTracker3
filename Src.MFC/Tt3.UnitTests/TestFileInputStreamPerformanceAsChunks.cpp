//
//  Tt3.UnitTests/TestFileInputStreamPerformanceAsChunks.cpp
//  
//  A test for the CFileInputStream performance (as chunks)
//
//////////
...
void TestFileInputStreamPerformanceAsChunks() throws(CTestException*)
{
    ...
    for (size_t iteration = 0; iteration < Iterations; iteration++)
    {
        ...
        {
            size_t chunkSize = min(RandomChunkSize, RandomDataSize - scan);
            size_t bytesRead = fis.Read(randomChunk, chunkSize);
...
END_TT3_NAMESPACE
//  End of Tt3.UnitTests/TestFileInputStreamPerformanceAsChunks.cpp
