//
//  Tt3.UnitTests/TestBinaryFileWriterPerformanceAsChunks.cpp
//  
//  A test for the CBinaryFileWriter output performance (as chunks)
//
//////////
...
END_TT3_NAMESPACE
//  End of Tt3.UnitTests/TestBinaryFileWriterPerformanceAsChunks.cpp
