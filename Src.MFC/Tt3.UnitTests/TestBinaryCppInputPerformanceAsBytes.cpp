//
//  Tt3.UnitTests/TestBinaryCppInputPerformanceAsBytes.cpp
//  
//  A test for the binary C++ input performance (as bytes)
//
//////////
...
END_TT3_NAMESPACE
//  End of Tt3.UnitTests/TestBinaryCppInputPerformanceAsBytes.cpp
