//
//  Tt3.UnitTests/TestBinaryCrtInputPerformanceAsBytes.cpp
//  
//  A test for the binary CRT input performance (as bytes)
//
//////////
...
END_TT3_NAMESPACE
//  End of Tt3.UnitTests/TestBinaryCrtInputPerformanceAsBytes.cpp
