//
//  Tt3.UnitTests/TestBufferedInputStreamPerformanceAsBytes.cpp
//  
//  A test for the CBufferedInputStream performance (as bytes)
//
//////////
...
END_TT3_NAMESPACE
//  End of Tt3.UnitTests/TestBufferedInputStreamPerformanceAsBytes.cpp
