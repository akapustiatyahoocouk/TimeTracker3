//
//  Tt3.UnitTests/TestBinaryCppOutputPerformanceAsBytes.cpp
//  
//  A test for the binary C++ output performance (in bytes)
//
//////////
...
void TestBinaryCppOutputPerformanceAsBytes() throws(CTestException*)
{
    ...
    for (size_t iteration = 0; iteration < Iterations; iteration++)
    {
        ...
        {
            f.put((char)randomChunk[i % RandomChunkSize]);
        }
        f.close();
        remove(tempFileName);
    }
...
END_TT3_NAMESPACE
//  End of Tt3.UnitTests/TestBinaryCppOutputPerformanceAsBytes.cpp
