...
namespace tt3::gui
{
    ...
    /// \class EnterActivityStopCommentDialog tt3-gui/API.hpp
    /// \brief The "Enter activity stop comment" modal dialog.
    ...
    public:
        ...
        /// \param task
        ///     The Activity that is being "Stoped".
        EnterActivityStopCommentDialog(
                ::QWidget * parent,
...
//  End of tt3-gui/EnterActivityStopCommentDialog.hpp
