...
#include "ui_ManageBeneficiariesDialog.h"
        ...
        _ui(new Ui::ManageBeneficiariesDialog)
{
    ...
    _beneficiaryManager = new tt3::gui::BeneficiaryManager(_ui->managerPanel);
    _managerPanelLayout->addWidget(_beneficiaryManager);
...
//////////
//  Operations
void ManageBeneficiariesDialog::doModal()
{
    exec();
}

//  End of tt3-gui/ManageBeneficiariesDialog.cpp
