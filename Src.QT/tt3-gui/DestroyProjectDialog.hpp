//
//  tt3-gui/DestroyProjectDialog.hpp - the modal "destroy Project" dialog
//
//  TimeTracker3
...
#include "tt3-gui/API.hpp"
    ...
    namespace tt3::gui
{
    /// \class DestroyProjectDialog tt3-gui/API.hpp
    /// \brief The modal "Destroy Project" dialog.
    ...
    public:
        ...
        enum Result
        {
            Ok,     ///<    Destruction confirmed; the Project has been destroyed.
    ...
    public:
        ...
        /// @param project
        ///     The Project whose destruction is to be performed.
        /// @param credentials
        ///     The credentials to use for accessing Project's data.
    ...
    private:
        ...
        //  Helpers
        static QString  _prompt(tt3::ws::Project project,
                               const tt3::ws::Credentials & credentials);
...
//  End of tt3-gui/DestroyProjectDialog.hpp
