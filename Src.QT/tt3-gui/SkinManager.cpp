...
bool SkinManager::register(ISkin * skin)
{
...
bool SkinManager::unregister(ISkin * skin)
{
    Q_ASSERT(skin != nullptr);
...
ISkin * SkinManager::find(const tt3::util::Mnemonic & mnemonic)
{
    _Impl * impl = _impl();
    tt3::util::Lock _(impl->guard);
