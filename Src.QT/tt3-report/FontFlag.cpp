//
//  tt3-report/FontFlag.cpp - tt3::report::FontFlag enum implementation
//
//  TimeTracker3
...
namespace
{
    ...
    {
        { FontFlag::Bold         , "bold"          },
        { FontFlag::Italic       , "italic"        },
        { FontFlag::Underline    , "underline"     },
        { FontFlag::StrikeThrough, "strikethrough" }
    };
}
...
namespace tt3::util
{
    ...
    QString toString<FontFlag>(
            const FontFlag & value
        )
    {
        ...
        Q_ASSERT(false);
        return toString(FontFlag::StrikeThrough);
    }

    template <> TT3_REPORT_PUBLIC
    auto fromString<FontFlag>(
            const QString & s,
            qsizetype & scan
        ) -> FontFlag
    {
...
//  End of tt3-report/FontFlag.cpp
