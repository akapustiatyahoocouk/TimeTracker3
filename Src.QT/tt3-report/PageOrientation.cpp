//
//  tt3-report/PageOrientation.cpp - tt3::report::PageOrientation enum implementation
//
//  TimeTracker3
...
namespace tt3::util
{
    ...
    QString toString<PageOrientation>(
        ...
        )
    {
        ...
        Q_ASSERT(false);
        return toString(PageOrientation::Default);
    }

    template <> TT3_REPORT_PUBLIC
    auto fromString<PageOrientation>(
            const QString & s,
            qsizetype & scan
        ) -> PageOrientation
    {
...
//  End of tt3-report/PageOrientation.cpp
