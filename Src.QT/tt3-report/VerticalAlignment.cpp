//
//  tt3-report/VerticalAlignment.cpp - tt3::report::VerticalAlignment enum implementation
//
//  TimeTracker3
...
namespace tt3::util
{
    ...
    QString toString<VerticalAlignment>(
        ...
        )
    {
        ...
        Q_ASSERT(false);
        return toString(VerticalAlignment::Default);
    }

    template <> TT3_REPORT_PUBLIC
    auto fromString<VerticalAlignment>(
            const QString & s,
            qsizetype & scan
        ) -> VerticalAlignment
    {
...
//  End of tt3-report/VerticalAlignment.cpp
