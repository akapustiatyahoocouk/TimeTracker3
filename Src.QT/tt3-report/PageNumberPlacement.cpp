//
//  tt3-report/PageNumberPlacement.cpp - tt3::report::PageNumberPlacement enum implementation
//
//  TimeTracker3
...
namespace tt3::util
{
    ...
    QString toString<PageNumberPlacement>(
            const PageNumberPlacement & value
        )
    {
        ...
        Q_ASSERT(false);
        return toString(PageNumberPlacement::Default);
    }

    template <> TT3_REPORT_PUBLIC
    auto fromString<PageNumberPlacement>(
            const QString & s,
            qsizetype & scan
        ) -> PageNumberPlacement
    {
...
//  End of tt3-report/PageNumberPlacement.cpp
