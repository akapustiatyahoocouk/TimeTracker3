//
//  tt3-report/CustomCharacterStyle.cpp - tt3::report::CustomCharacterStyle class implementation
//
//  TimeTracker3
...
void CustomCharacterStyle::_deserialize(const QDomElement & styleElement)
{
    CustomStyle::_deserialize(styleElement);
}

//  End of tt3-report/CustomCharacterStyle.cpp
