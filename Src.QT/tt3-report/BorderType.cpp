//
//  tt3-report/BorderType.cpp - tt3::report::BorderType enum implementation
//
//  TimeTracker3
...
namespace tt3::util
{
        ...
        )
    {
        ...
        Q_ASSERT(false);
        return toString(BorderType::Default);
    }

    template <> TT3_REPORT_PUBLIC
    auto fromString<BorderType>(
            const QString & s,
            qsizetype & scan
        ) -> BorderType
    {
...
//  End of tt3-report/BorderType.cpp
