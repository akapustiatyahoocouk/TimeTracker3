//
//  tt3-help-client/Components.hpp - tt3-help-client Components
//
//  TimeTracker3
...
{
    /// \class Component tt3-help-client/API.hpp
    /// \brief The "TT3 Admin skin" component.
    class TT3_HELP_CLIENT_PUBLIC Component final
        :   public virtual tt3::util::IComponent
    {
        ...
        //  Types
    public:
        /// \class Resources tt3-help-client/API.hpp
        /// \brief The component's resources.
        class TT3_HELP_CLIENT_PUBLIC Resources final
            :   public tt3::util::FileResourceFactory
        {
            DECLARE_SINGLETON(Resources)
        };

        /// \class Settings tt3-help-client/API.hpp
        /// \brief The component's settings.
        class TT3_HELP_CLIENT_PUBLIC Settings final
...
//  End of tt3-help-client/Components.hpp
