//
//  tt3-db-xml/WorkStream.hpp - a work stream
//
//  TimeTracker3
...
{
    /// \class WorkStream tt3-db-xml/API.hpp
    /// \brief A work stream in an XML file database.
    class TT3_DB_XML_PUBLIC WorkStream final
        :   public Workload,
    ...
    private:
        WorkStream(Database * database, tt3::db::api::Oid oid);
        virtual ~WorkStream();
