//
//  tt3-db-sqlite3/DatabaseAddress.cpp - tt3::db::sqlite3::DatabaseAddress class implementation
//
//  TimeTracker3
...
DatabaseAddress::State DatabaseAddress::state() const
{
    ...
    tt3::util::Lock _(databaseType->_databaseAddressesGuard);
...
//  End of tt3-db-sqlite3/DatabaseAddress.cpp
